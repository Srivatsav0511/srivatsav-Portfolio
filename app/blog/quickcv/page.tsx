  ...
  return (
    <article className="min-h-screen bg-zinc-950 text-zinc-100 selection:bg-zinc-700">
      ...
      <header className="relative z-10 max-w-4xl mx-auto px-6 pt-28 pb-10 text-center md:text-left">
        ...
        <h1 className="mt-4 text-5xl md:text-7xl font-bold tracking-tight text-white">QuickCV</h1>
        <p className="mt-4 text-xl text-zinc-300">Built for fun, made to help people create better resumes faster.</p>
      </header>
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 mb-16">
        <div className="relative aspect-[16/9] rounded-3xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-sm">
          <Image src="/quickcv/quickcv-cover.png" alt="QuickCV workspace" fill className="object-cover" priority />
        </div>
      </div>
      ...
      <main className="relative z-10 max-w-3xl mx-auto px-6 pb-20 space-y-10">
        ...
        <a href="https://quickcv1.netlify.app/" target="_blank" className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-zinc-100 text-zinc-950 font-bold hover:bg-white transition-colors">
          Launch QuickCV

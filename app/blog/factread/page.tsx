    ...
    <article className="min-h-screen bg-zinc-50 text-zinc-900 selection:bg-zinc-200">
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-5 pb-20 md:px-6 md:pb-24">
        <div className="flex flex-wrap items-center justify-center gap-5 text-sm font-medium text-zinc-600">
          <Link href="/privacy/factread" className="inline-flex items-center gap-1 hover:text-zinc-900">
            Privacy
            <ArrowUpRight size={13} />
          </Link>
          <Link href="/support/factread" className="inline-flex items-center gap-1 hover:text-zinc-900">
            Support
            <ArrowUpRight size={13} />
          </Link>
          <a href="https://apps.apple.com/us/app/factread-swipe-to-read/id6762402891" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1 hover:text-zinc-900">
            App Store
            <ArrowUpRight size={13} />
          </a>
        </div>

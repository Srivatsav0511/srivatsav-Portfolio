...
const blogItems: BlogItem[] = [
  {
    title: 'How I built Holdboard app',
  ...
  {
    title: 'How I built FactRead app',
  ...
  {
    title: 'How I built MoneyFormula app',
  ...
  {
    title: 'How I built Pureclick Walls app',
  ...
  {
    title: 'How I built CodeClarity web app',
  ...
  {
    title: 'How I built QuickCV web app',
